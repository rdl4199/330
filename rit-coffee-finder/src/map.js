...
function loadMarkers() {
    ...
    for (let shop of coffeeShops) {
        ...
        for(const feature of geojson.features){
            addMarkersToMap(feature.geometry.coordinates, feature.properties.title, feature.properties.description, "marker");
        }
    }
    console.log(geojson.features);
}
function addMarkersToMap(coordinates, title, description, className) {
    // add markers to map
